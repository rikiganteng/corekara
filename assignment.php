<html>
	...
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
		...
		<body>
			...
			<?php
			// Run this Code when User Input Zipcode
			
			if (isset($_POST['zipcode'])) {
				// Use RapidAPI to Search For City Name with Japanese Zip Code
				...
				$curl_city = curl_init();
				//Convert Japanese City Name to URL Encode for API Purpose
				$test = rawurlencode($city_name);
				
				//Search For LocationKey with City Name as Query Using AccuWeather API
				...
				// Get The Key and Romaji name for City and Prefecture
				...
				// Get Weather Forecast Using LocationKey above with AccuWeather
				...
				$forecast = json_decode($response_forecast, true);
					//Loop the Weather Detail and limit the Forecast to 3 Day
					for ($i = 0; $i <= 2; $i++) {
